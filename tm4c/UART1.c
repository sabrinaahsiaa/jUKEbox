...
void UART1_Init(void){
  ...
  GPIO_PORTB_AMSEL_R &= ~0x03;          // disable analog functionality on PB
	...
	// sets up interrupts to exit the function
}
...
void UART1_OutString(char *pt){
  while(*pt){
	...
	// adds zero to the end of the string to let MCU know that 
...
// Takes one char at a time
// Waits for enter to be pressed
unsigned char UART1_InColor(char *bufPt){
int length=0;
char character;
